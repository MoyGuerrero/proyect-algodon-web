<template>
  ...
  <aside id="sidebar-multi-level-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 flex flex-col justify-between"
...
const { menus, isVisibleAside, openOptions } = useSideBar();
</script>
