...
export const mainRoutes: RouteRecordRaw = {
  ...
  children: [
    ...
    { path: 'recibas', name: 'recibas', component: () => import('@/module/main/views/Recibas/RecibasView.vue') },
    { path: 'calculo-compra', name: 'calculo-compra', component: () => import('@/module/main/views/Calc/CalculoCompra.vue') },
