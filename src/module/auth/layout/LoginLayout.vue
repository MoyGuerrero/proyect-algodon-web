      ...
      <form action="">
        <div class="mb-4">
          ...
          <div class="relative flex items-center">
            ...
            <input type="text" class="w-full border border-gray-300 py-1.5 rounded-lg pl-8 text-sm" name=""
              id="txtUsuario">
          </div>
        </div>
        <div class="mb-4">
          ...
          <div class="relative flex items-center">
            ...
            <input :type="padlockOpen ? 'text' : 'password'"
              class="w-full border border-gray-300 py-1.5 rounded-lg pl-8 text-sm" name="" id="txtPassword">
          </div>
        </div>
